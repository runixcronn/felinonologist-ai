...
const Skeleton = ({ className }: { className?: string }) => (
  <div className={`animate-pulse bg-gradient-to-r from-zinc-300 via-zinc-200 to-zinc-300 dark:from-zinc-700 dark:via-zinc-600 dark:to-zinc-700 bg-[length:200%_100%] rounded ${className}`} 
...
export default function ProfilePage() {
    ...
    return (
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-to-bl from-orange-500/10 via-transparent to-transparent rounded-full blur-3xl" />
          <div className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-gradient-to-tr from-orange-600/10 via-transparent to-transparent rounded-full blur-3xl" />
        </div>
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-to-bl from-orange-500/10 via-transparent to-transparent rounded-full blur-3xl animate-pulse" />
        <div className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-gradient-to-tr from-orange-600/10 via-transparent to-transparent rounded-full blur-3xl" />
          ...
          <div className="lg:col-span-1">
            <div className="glass-strong rounded-3xl p-8 text-center relative overflow-hidden group">
              ...
              <div className="relative inline-block mb-6">
                ...
                <div className="absolute -inset-2 bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 rounded-full opacity-20 blur-sm group-hover:opacity-40 transition-opacity" />
                <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full animate-spin-slow opacity-30" style={{ animationDuration: '8s' }} />
                ...
                <button 
                  ...
                  className="absolute -bottom-1 -right-1 p-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-full shadow-lg shadow-orange-500/30 transition-all duration-300 hover:scale-110 disabled:opacity-70 disabled:hover:scale-100"
                >
          ...
          <div className="lg:col-span-2 space-y-6">
            <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl opacity-0 group-focus-within:opacity-20 transition-opacity blur" />
              ...
              <div className="flex justify-end">
                ...
                >
                  {/* Button Glow */}
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-500 rounded-xl opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-300" />
